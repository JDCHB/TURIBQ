function turista() {
    console.log("si entra  ")
        axios({
            method: 'GET',
            url: 'http://127.0.0.1:3000/visitas_turista'
            ...
            for (let i = 0; i < response.data.length; i++) {
                const uno = response.data[i].Nombre_turista; 
                const dos = response.data[i].cantidad_visitas; 
                labels.push(uno);
                data.push(dos);
            }
            let b = 0
            ...
            for (let i = 0; i < response.data.length; i++) {
                ...
                var grafica2 = document.getElementById("grafica3").getContext("2d");
